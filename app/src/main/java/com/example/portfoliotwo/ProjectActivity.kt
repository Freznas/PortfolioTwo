...
class ProjectActivity : AppCompatActivity() {
    ...
    val projectList = listOf(
        ...
        Project("Portfolio", "https://github.com/Freznas/PortfolioTwo.git",
            R.drawable.kodsnutt_portfolio),
        Project("NotePad", "https://github.com/Freznas/NotePad.git",
            R.drawable.notepad_exempel),
        Project("Giuseppe's trattoria", "https://github.com/Freznas/Restaurant_Menu.git",
            R.drawable.trattoria_exempel),
        Project("Furious Criminal's Kalkylator", "https://github.com/Freznas/furious_criminals_kalkylator.git",
